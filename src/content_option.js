...
const dataportfolio = [{
    ...
    {
        heading:"Reacts (ongoing)",
        img: "",
        description: "A dynamic Twitter clone built with React.js. Experience the real-time, interactive nature of Twitter with a sleek and responsive user interface. ReactTweet allows users to tweet, like, and retweet, fostering engaging conversations.",
